...
export default function RecipeDetailsClient({ recipe, user, id }) {
  ...
  return (
    <div className="w-full px-4 md:px-6 pt-8 pb-20 bg-[#fdfdfb] dark:bg-zinc-950 min-h-screen transition-colors">
          ...
          >
            ...
            <div className="text-left">
              <h4 className="text-sm font-bold tracking-wide">
                Administrator Oversight Activated
              </h4>
              <p className="text-xs opacity-90 mt-0.5">
                You are viewing this recipe with admin privileges. You can
                monitor user flags, reviews, and transaction logs.
              </p>
            </div>
          </motion.div>
        )}
            ...
            <div className="flex items-center gap-3.5 text-emerald-800 dark:text-emerald-400 text-left">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
                  Manage performance metrics, read student reviews, and update
                  recipe content directly.
                </p>
              </div>
            </div>
            <Button
              ...
              onClick={() =>
                router.push(`/dashboard/user/recipes/${recipe._id}/edit`)
              }
            >
              Edit Recipe Content
            </Button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="relative rounded-[40px] overflow-hidden group shadow-2xl bg-zinc-900 aspect-[16/10] md:aspect-[16/9] w-full border border-zinc-100 dark:border-zinc-900">
              ...
              <div className="absolute bottom-0 left-0 p-6 md:p-12 text-white space-y-4 w-full">
                ...
                <p className="text-zinc-300 font-medium text-sm md:text-base max-w-2xl opacity-90 line-clamp-2 text-left leading-relaxed">
                  A carefully balanced, artisan culinary template crafted and
                  shared by{" "}
                  <span className="text-emerald-400 font-bold">
                    {recipe.authorName}
                  </span>
                  . Perfect for culinary enthusiasts looking to perfect their
                  skills.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-5 bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800/80 p-5 rounded-3xl shadow-sm">
              <div className="flex items-center gap-6">
                ...
                {isOwner ? (
                  ...
                  >
                    {isLiked ? (
                      <FaHeart
                        className="text-rose-500 scale-110 transition-transform"
                        size={17}
                      />
                    ) : (
                      <FiHeart
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 text-sm font-bold transition-colors group ${
                      isFavorited
                        ...
                        : "text-zinc-600 dark:text-zinc-300 hover:text-emerald-700"
                    }`}
                  >
                    {isFavorited ? (
                      <FaStar
                        className="text-amber-500 scale-110 transition-transform"
                        size={17}
                      />
                    ) : (
                      <FiStar
                        className="text-zinc-400 group-hover:text-emerald-700"
                        size={17}
                      />
                    )}
              ...
              {!user ? (
                <>
                 <Link href={`/auth/signin?redirect=/recipes/${recipe._id}`}>
              ...
              <div className="space-y-4 font-sans text-sm">
                <div className="flex items-center justify-between py-2 border-b border-zinc-100 dark:border-zinc-800/60">
                  ...
                  <span className="font-bold text-zinc-800 dark:text-zinc-200">
                    {recipe.preparationTime || "25 Mins"}
                  </span>
                </div>
              ...
              <div className="bg-white dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-900 rounded-[32px] p-6 shadow-sm space-y-3.5">
                ...
                {!user ? (
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="bg-[#042f1e] w-full dark:bg-emerald-800 text-white font-bold rounded-2xl px-6 h-11 shadow-sm text-xs"
                    startContent={<FiShoppingCart size={14} />}
                  >
                    Login Before Buy
                  </Button>
            ...
            <div className="bg-[#05291b] text-zinc-100 rounded-[32px] p-6 shadow-xl space-y-4 border border-emerald-950">
              <div>
                ...
                <p className="text-zinc-300 text-xs md:text-sm italic font-medium leading-relaxed mt-2.5 text-left">
                  "Always measure your ingredients carefully before prepping.
                  Perfect temperature sync and fresh aromatic spices are the
                  core secrets behind creating a top-tier premium dish."
                </p>
              </div>
